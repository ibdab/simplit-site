...
const previewLines = [
  "Simplit detects the selected text and keeps the answer ready in a slim top island.",
  "For a question, Simplit gives the answer first, then a short reason so it stays easy to use.",
  "Pro adds image tools, Sneaky Mode, faster responses, and a stronger model for heavier work."
];
